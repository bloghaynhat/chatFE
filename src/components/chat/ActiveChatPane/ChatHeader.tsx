                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          ...
                          } else if (action.id === "ai-extract-tasks") {
                          ...
                          } else if (action.id === "ai-smart-search") {
                            setIsHeaderSearchOpen(true);
                            // We could trigger a special state, but we'll use the existing search bar with an AI prefix or toggle
                  ...
                  if (
                    ...
                    if (query) {
                      ...
                      try {
                        ...
                        // Custom event or callback to show results, passing it up to parent or handling locally
                        // Let's fire a simple alert for now to show it works, in real life we'd show a modal
                        if (result?.data?.results) {
                          alert(
                            `AI Search Results:\n\n${result.data.results.map((r: any) => `- ${r.content}`).join("\n")}`,
                          );
                        } else {
                          alert(
