    ...
    <div className="fixed inset-0 z-[120] flex items-end justify-center bg-black/35 px-0 sm:items-center sm:px-4">
      <div className="flex max-h-[90vh] w-full max-w-[420px] flex-col overflow-hidden rounded-t-[20px] border border-gray-200 bg-[#f5f7fa] shadow-2xl dark:border-slate-700 dark:bg-slate-950 sm:rounded-[20px]">
        ...
        <div className="space-y-2 overflow-y-auto px-3 py-3">
          ...
          <section className="overflow-hidden rounded-xl bg-white dark:bg-slate-900">
            <SettingRow label="Allow changing vote" checked={allowChangeVote} onChange={setAllowChangeVote} />
            <div className="ml-10 h-px bg-gray-100 dark:bg-slate-800" />
            <SettingRow label="Show results early" checked={showResultsBeforeClose} onChange={setShowResultsBeforeClose} />
            <div className="ml-10 h-px bg-gray-100 dark:bg-slate-800" />
            <SettingRow label="Members can add options" checked={allowAddOption} onChange={setAllowAddOption} />
            <div className="ml-10 h-px bg-gray-100 dark:bg-slate-800" />
            <SettingRow label="Multiple votes" checked={isMultipleChoice} onChange={setIsMultipleChoice} />
            <div className="ml-10 h-px bg-gray-100 dark:bg-slate-800" />
            <SettingRow label="Hide voters" checked={hideVoters} onChange={setHideVoters} />
          </section>
